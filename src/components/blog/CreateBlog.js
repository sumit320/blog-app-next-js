        ...
        <form>
          ...
          <div className="flex items-center mb-6">
            <UploadButton
              ...
              className="ut-button ut-ready ut-readying ut-uploading mt-4"
              onClientUploadComplete={(res) => {
                if (res && res[0]) {
                  setValue("coverImage", res[0].ufsUrl); // updated
              ...
              content={{
                button: (
                  <div className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg cursor-pointer hover:bg-gray-800 transition">
                    <PlusCircle className="h-5 w-5 ut-icon" />
